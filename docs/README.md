...
Windows. It observes the game window during wild battles and displays:

- live catch probabilities for each Poké Ball  
- a “missing here” Pokédex panel while walking  
