...
from battle.catch_math import ball_probs, battle_context, format_line, resolve_enemy
...
class LiveLoop:
    ...
    def __init__(
        ...
        self.settings_panel.on_dump_debug = lambda: trigger_debug_dump(
            getattr(self, "_last_frame", None),
            getattr(self, "_last_reading", None),
            self.cal,
        )
